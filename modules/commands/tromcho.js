...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (!mention[0]) return api.sendMessage("Vui lòng tag 1 người.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝗕𝗮̣𝗻 𝗖𝗼𝗶 𝗖𝗵𝘂̛̀𝗻𝗴 𝗧𝗼̂𝗶 𝗕𝗲̂́ 𝗕𝗮̣𝗻 𝗗𝗼́🤗😍😳😚", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
}

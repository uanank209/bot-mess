const fbname = "VqnThuqn";
const githubname = "JunƯoo";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillText("𝑲𝒆𝒏 𝑩𝑶𝑻", canvas.width / 2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("UPTIME BOT", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("@RqzaX.040", 1200, 2750);
    ctx.fillStyle = "#99FFFF"
    ctx.fillText("RqzaX_040.VT", 1600, 3150);
    ctx.fillStyle = "#FFCC33"
   ctx.fillText("RqzaX.VqnThuqn.040", 2000, 3600);
    ctx.beginPath();

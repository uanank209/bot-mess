...
module.exports.config = {
    ...
    envConfig: {
        ...
        key: "eSA3Nik3" //reg key: https://www.nguyenmanh.name.vn/docs
...
module.exports.run = async ({
    ...
    try {
        ...
        let os = (await axios.get(encodeURI(`https://www.nguyenmanh.name.vn/api/tikSearch?query=${search}&apikey=eSA3Nik3`))).data

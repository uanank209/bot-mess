...
"https://i.imgur.com/urLh5YY.mp4",
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`==Những bản nhạc chill==\n==Nhạc chill thư giãn😚==\n━━━━━━━━━━━━━━━━\n「 Nghe nhạc đi ${name} 」\n\n Chúc ${name} nghe nhạc vui vẻ, chúc fen 1 ngày hạng phúccc😘 `,attachment: fs.createReadStream(__dirname + "/cache/5.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.mp4"));

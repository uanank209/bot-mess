  ...
  switch (handleReply.type) {
    ...
    case 'reply': {
      ...
      try {
        ...
        return api.sendMessage('[⚜️]→ Vui lòng reply các lựa chọn dưới đây:\n1. Tải video\n2. Tải audio', threadID, 
        ...
        return api.sendMessage('[⚜️]→ Đã có lỗi xảy ra, không thể thực hiện lệnh lúc này!', threadID, messageID);
      }
    }
    default: return
  }

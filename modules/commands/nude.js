...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Mấy ba khoái lắm😼\n» Số dư: -300 đô «\n📩https://www.facebook.com/profile.php?id=100018004437028`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
